...
WiFiSetupManager::WiFiSetupManager(const char *apName, const IPAddress &apIP, const IPAddress &subnet)
...
void WiFiSetupManager::runBlocking()
{
    begin();
    while (!process())
    {
...
byte WiFiSetupManager::getStatus() const
{
    return status;
}

// --- Private methods ---
void WiFiSetupManager::handleConnect()
{
...
void WiFiSetupManager::handleExit()
{
